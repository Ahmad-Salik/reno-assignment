      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-300">Update the selected notice details.</p>
          </div>
        ...
        {notice ? <NoticeForm initialData={notice} onSubmit={handleSubmit} isSubmitting={isSubmitting} /> : <p className="text-slate-500 dark:text-slate-300">Loading...</p>}
      </div>
    </div>
  );
}
